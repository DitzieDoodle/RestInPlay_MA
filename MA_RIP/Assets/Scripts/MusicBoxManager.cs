...
public class MusicBoxManager : MonoBehaviour
{
    ...
    // �ffentliche Methoden f�r deine Dialog-Nodes
    ...
    private AudioClip GetRandomClipAvoidingCurrent()
    {
        ...
        // ziehe zuf�llig, bis ein anderer Clip gefunden ist (max. ein paar Versuche)
        for (int i = 0; i < 10; i++)
        {
    ...
    public void PlayMusic(AudioClip clip)
    {
        ...
        // Wenn dieser Clip bereits l�uft, nichts tun
